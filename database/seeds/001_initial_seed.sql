-- ============================================================
-- XMONEY Seed Data — Local Development
-- ============================================================
USE xmoney;
...
('AED', 'UAE Dirham', 'د.إ', 2, 1, 1, 1, 10),
('USD', 'US Dollar', '$', 2, 1, 1, 1, 20),
('INR', 'Indian Rupee', '₹', 2, 1, 0, 1, 30),
('PKR', 'Pakistani Rupee', 'Rs', 2, 1, 0, 1, 40),
('EUR', 'Euro', '€', 2, 1, 1, 1, 50),
('GBP', 'British Pound', '£', 2, 1, 1, 1, 60);
...
-- Temporary bcrypt for "ChangeMe@XMONEY2026" — always re-run seed-admin.php after import
