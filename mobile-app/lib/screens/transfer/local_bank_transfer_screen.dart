...
/// Local bank transfer in the customer's registered country.
class LocalBankTransferScreen extends StatefulWidget {
  const LocalBankTransferScreen({super.key, required this.router});

  final AppRouter router;

  @override
  State<LocalBankTransferScreen> createState() => _LocalBankTransferScreenState();
}

class _LocalBankTransferScreenState extends State<LocalBankTransferScreen> {
  ...
  Future<void> _boot() async {
    ...
    final banks = LocalTransferRepository.instance.banksForCountry(country.countryCode);
    if (!mounted) return;
    setState(() {
      _country = country;
      _banks = banks;
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: const Text('Local Bank Transfer', style: TextStyle(fontWeight: FontWeight.w700, fontSize: 18)),
        centerTitle: true,
      ),
              ...
              child: ConstrainedBox(
                ...
                child: ListView(
                  ...
                  children: [
                    ...
                    Text(
                      'Banks available in ${country.countryName}',
                    ...
                    FilledButton(
                      onPressed: _selectedBank != null
                          ? () => showXmSnack(context, 'Local bank transfer review — coming next')
                          : null,
